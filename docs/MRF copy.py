...
class MacroRandomForest:
    ...
    Args:
        ...
        n_cores (int, default -1): Default value of -1 specifies that all available cores will be used. Use a different integer to specify fewer (but > 1) cores.
    ...
    def __init__(self, data, x_pos, oos_pos, S_pos='', y_pos=0,
                 ...
                 S_priority_vec=None, trend_push=1,  random_x=False, howmany_random_x=1,
                 howmany_keep_best_VI=20,  prior_mean=[], prior_var=[], subsampling_rate=0.75,
